...
Use [the template](TEMPLATE.md). Keep accepted records; supersede them explicitly
when a later choice replaces them. Record significant tradeoffs, not every edit.
...
- [ADR-005: Optional ads outside gameplay](ADR-005-monetization.md) — Accepted
