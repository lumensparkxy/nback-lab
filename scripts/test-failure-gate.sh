...
rm -f engine/build/test-results/test/TEST-com.maswadkar.nback.engine.HarnessFailureProbeTest.xml artifacts/expected-failure.xml
...
report = Path('engine/build/test-results/test/TEST-com.maswadkar.nback.engine.HarnessFailureProbeTest.xml')
